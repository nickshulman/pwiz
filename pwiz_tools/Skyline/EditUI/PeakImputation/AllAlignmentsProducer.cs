...
{
    public class AllAlignmentsProducer : Producer<AllAlignmentsProducer.Parameter, AllAlignments>
    {
        public static readonly AllAlignmentsProducer INSTANCE = new AllAlignmentsProducer();
