...
connectionname = sys.argv[0]
toolservicecmdexe = os.path.dirname(os.path.realpath(__file__)) + "/ToolServiceCmd.exe"
p = subprocess.Popen([toolservicecmdexe, 'GetReport'], stdin=subprocess.PIPE, stdout=subprocess.PIPE)
report_text = p.communicate(input=report_proteinlocators)
