...
{
    public class DocNodeChildren : IList<DocNode>, IReadOnlyList<DocNode>
    {
        public static readonly IEqualityComparer<Identity> IDENTITY_EQUALITY_COMPARER =
            new IdentityEqualityComparer<Identity>();
