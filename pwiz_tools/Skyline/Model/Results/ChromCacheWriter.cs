                ...
                try
                {
                    if (x == null && !_status.IsFinal)
                    {
                        ...
                        if (_fs.Stream != null)
                        {
                            ...
                            {
                                throw new IOException(TextUtil.LineSeparate(string.Format(Resources.ChromCacheWriter_Complete_Failure_attempting_to_write_the_file__0_, _fs.RealName), xWrite.Message), xWrite);
                            }
                        }
