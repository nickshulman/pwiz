...
using static pwiz.Skyline.Model.Results.ProtoBuf.ResultFileMetaDataProto.Types;
...
namespace pwiz.Skyline.Model.Results
{
    internal sealed class SpectraChromDataProvider : ChromDataProvider
    {
        ...
        private int GetScanIdIndex(MsDataSpectrum dataSpectrum)
        {
            if (_scanIdDictionary.TryGetValue(dataSpectrum.Id, out int scanIndex))
            {
                return scanIndex;
            }

            return GetScanIdIndex(SpectrumSummary.FromSpectrum(dataSpectrum));
        }
