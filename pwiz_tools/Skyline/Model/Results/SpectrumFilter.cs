...
namespace pwiz.Skyline.Model.Results
{
    ...
    public sealed class SpectrumFilter : IFilterInstrumentInfo
    {
        ...
        private SearchParameters _xcorrSearchParamters;
        ...
        {
            _xcorrSearchParamters = SearchParameters.DEFAULT.ChangeFragmentationType(FragmentationType.CID);
        ...
        */
        ...
        public IEnumerable<ExtractedSpectrum> Extract(double? retentionTime, MsDataSpectrum[] spectra)
        {
            ...
            var filterPairs = GetIsolationWindows(spectra[0].GetPrecursorsByMsLevel(1))
