...
//            }
        ...
        public void SetupCalculatorChooser()
        {
            ...
            var autoItem = new ToolStripMenuItem(SkylineResources.SkylineWindow_SetupCalculatorChooser_Auto, null, delegate { ChooseCalculator(null); })
                            {
                                Checked = null == Settings.Default.RtCalculatorOption
                            };
