    ...
    public class CalibrationCurveFitterTest : AbstractUnitTest
    {
        ...
        public void TestDilutionFactor()
        {
            ...
            for (int replicateIndex = 0; replicateIndex < baseDocument.MeasuredResults.Chromatograms.Count; replicateIndex++)
            {
                ...
                var specifiedBaseConcentration = chromatogramSet.AnalyteConcentration.Value * baseCurveFitter.PeptideListQuantifier.PeptideDocNode.ConcentrationMultiplier.GetValueOrDefault(1);
