...
namespace pwiz.Skyline.ToolsUI
{
    public partial class PythonInstaller : FormEx
    {
        ...
        public string PythonEmbeddablePackageDownloadPath => PythonEmbeddablePackageDownloadDir + BACK_SLASH + PythonEmbeddablePackageFileName;
        public string PythonEmbeddablePackageExtractDir => PythonEmbeddablePackageDownloadDir + BACK_SLASH + PythonEmbeddablePackageFileBaseName;
        ...
        public string VirtualEnvironmentDir => PythonEmbeddablePackageDownloadDir + BACK_SLASH + VirtualEnvironmentName;
        ...
        private string PythonEmbeddablePackageDownloadDir => CreateDirIfNotExist(PythonRootDir + BACK_SLASH + PythonVersion);
        ...
        private string PythonRootDir { get; } = CreateDirIfNotExist(PythonUtil.PythonRootDir);
        ...
        {
            var tasks = ValidatePythonVirtualEnvironment();
            ...
            if (numCompletedTasks == tasks.Count)
            {
        ...
        private List<Task> ValidatePythonVirtualEnvironment()
        {
            ...
            {
                var isTaskValid = TaskValidator.Validate(taskNode.TaskName);
                if (hasSeenFailure)
                {
            ...
            switch (taskName)
            {
                ...
                case TaskName.create_virtual_environment:
                    var task7 = new Task(() => RunPythonModule(
                        BasePythonExecutablePath, PythonEmbeddablePackageDownloadDir, VIRTUALENV, new [] {VirtualEnvironmentName}));
    ...
    public abstract class PythonInstallerTaskValidatorBase : IPythonInstallerTaskValidator
    {
        ...
        protected abstract bool ValidateDownloadPythonEmbeddablePackage();
        protected abstract bool ValidateUnzipPythonEmbeddablePackage();
        protected abstract bool ValidateEnableSearchPathInPythonEmbeddablePackage();
        protected abstract bool ValidateDownloadGetPipScript();
        protected abstract bool ValidateRunGetPipScript();
        protected abstract bool ValidatePipInstallVirtualenv();
        protected abstract bool ValidateCreateVirtualEnvironment();
        protected abstract bool ValidatePipInstallPackages();
    }

    public class TestPythonInstallerTaskValidator : PythonInstallerTaskValidatorBase
    {
    ...
    public class PythonInstallerTaskValidator : PythonInstallerTaskValidatorBase
    {
        protected override bool ValidateDownloadPythonEmbeddablePackage()
        {
